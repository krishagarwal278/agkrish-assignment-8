...
def do_experiments(start, end, step_num):
    ...
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, 'b-o')
    ...
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, 'r-o')
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, 'g-o')
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, 'm-o')
   ...
   # Implement: Plot beta0 / beta2 (Intercept ratio)
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, [-b0/b2 for b0, b2 in zip(beta0_list, beta2_list)], 'c-o')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, 'y-o')
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, 'k-o')
